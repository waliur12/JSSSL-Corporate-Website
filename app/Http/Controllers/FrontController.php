...
class FrontController extends Controller {
    ...
    public function noticeDetails($id) {
        // dd($id);
        if ($id==1) {
            $pdf_url=asset('/frontend/notices/1.OperationSupportSupervisor.pdf');
          }
  
          elseif($id==2){
              $pdf_url=asset('/frontend/notices/2.OperationSupportCS.pdf');
          }
          elseif($id==3){
              $pdf_url=asset('/frontend/notices/3.ContentWriters.pdf');
          }
          elseif($id==4){
              $pdf_url=asset('/frontend/notices/4.GraphicDesigner.pdf');
          }
          elseif($id==5){
              $pdf_url=asset('/frontend/notices/5.VideoEditor.pdf');
          }
          elseif($id==6){
              $pdf_url=asset('/frontend/notices/6.MarketingExecutives.pdf');
          }
          
          // dd($pdf_url);
           return view('front.job_notice_details',compact('pdf_url'));
