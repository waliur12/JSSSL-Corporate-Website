                    ...
                    <div class="ms-panel-body">
                        <div class="addnewdata">
                            <button type="button" class="btn btn-sm btn-pill btn-dark has-icon clientBtn" title="Add"
                                data-toggle="modal" data-target="#myModalSave"><i class="fa fa-plus"></i> News</button>
                        </div>
                                    ...
                                    @foreach ($all_news as $val)
                                        <tr role="row" class="item{{ $val->news_id }}">
                                            ...
                                            <td class="text-center">
                                                {{ \Illuminate\Support\Str::limit($val->formated_description, 25, $end = '...') }}
                                            </td>
                                            <td class="text-center"><img src="{{ asset($val->news_image) }}"
                                                    style="width: 45px; height: 45px;" /></td>
                                            <td>{{ \Carbon\Carbon::parse($val->news_published_at)->format('jS F, Y') }}
                                            </td>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="headCenter">
                        <h5 class="modal-title mt-0" id="myModalLabel">Add New News</h5>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div id="newsSave">
                        <div class="form-group row flex_css">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="news_title" placeholder="Title Name...">
                            </div>
                        </div>
                        <div class="form-group row flex_css">
                            <label for="name" class="col-sm-3 col-form-label">Description</label>
                            <div class="col-sm-9">
                                <textarea class="form-control " name="news_description" id="description" cols="30"
                    ...
                    <div class="form-group row flex_css">
                        ...
                        <div class="col-sm-9">
                            <input type="file" name="image" data-allowed-file-extensions="png jpg jpeg GIF"
                                class="dropify" />
                        </div>
                    </div>
    ...
    <div id="myModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="headCenter">
                        <h5 class="modal-title mt-0" id="myModalLabel"> Update News</h5>
                    </div>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    ...
                    <div id="newsUpdate">
                        ...
                        <div class="form-group row flex_css">
                            <label for="name" class="col-sm-3 col-form-label">Description</label>
                            <div class="col-sm-9">
                                <textarea class="form-control description" name="news_description" id="news_description"
                    ...
                    <div class="form-group row flex_css">
                        <label for="portfolio_cat_icon" class="col-sm-3 col-form-label">Image</label>
                        <div class="col-sm-9">
                            <input type="file" name="image" id="image2" data-allowed-file-extensions="png jpg jpeg GIF"
                                class="dropify" />
                        </div>
                    </div>
    ...
    <div id="viewModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="headCenter">
                        <h5 class="modal-title mt-0" id="myLargeModalLabel">News Details</h5>
                    </div>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.data.news_image) {
                            var img_url = '{!! URL::to('/') !!}' + "/" + response.data
                                .news_image;
            ...
            $('#reload-category').on('click', '.viewData', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#viewImage').html(
                            `<img width="300" height="300" class="img-fluid"  src="${url}/${response.data.news_image}"/>`
                            );
                        ...
                        if (response.status == 0) {
                            ...
                            if (response.status = true) {
                                ...
                                var tst = content_table.row.add([
                                    ...
                                    '<img src="' + response.data.news_image +
