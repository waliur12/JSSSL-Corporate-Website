                ...
                <table id="socialMedia" class="table w-100 table-striped dataTable no-footer" role="grid" aria-describedby="data-table-4_info" style="width: 1098px;">
                    <thead>
                        <tr role="row">
                            ...
                            <th class=" text-center" style="width: 20%;">Dated At</th>
    ...
    <div class="modal-dialog">
       <div class="modal-content">
           <div class="modal-header">
               <div class="headCenter"><h5 class="modal-title mt-0" id="myModalLabel">Add New Event</h5></div>
           ...
           <div class="modal-body">
              ...
              <div id="eventSave">
                  ...
                  <div class="form-group row flex_css">
                      ...
                      <div class="col-sm-9">
                          <textarea   class="form-control description" name="event_description" id="description"  cols="30" rows="10" placeholder="Description here..."></textarea>
                      </div>
                  </div>
                  <div class="form-group row flex_css">
              ...
              <div class="modal-body">
                  ...
                  <div id="eventUpdate">
                      ...
                      <div class="form-group row flex_css">
                          <label for="name" class="col-sm-3 col-form-label">Description</label>
                          <div class="col-sm-9">
                              <textarea   class="form-control description" name="event_description" id="event_description"  cols="30" rows="10" placeholder="Description here..."></textarea>
                          </div>
                      </div>
                      <div class="form-group row flex_css">
        ...
        $('#reload-category').on('click', '.media-edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        try {
                            CKEDITOR.instances['event_description'].destroy(true);
                        } catch (e) {}
                        CKEDITOR.replace('event_description');
                        $('#event_dated_at').val(response.data.published_date);
            ...
            $('#reload-category').on('click', '.viewData', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#viewDated').html(response.data.formated_date);
