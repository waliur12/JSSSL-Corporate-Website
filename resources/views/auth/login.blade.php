             ...
             @csrf
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input id="validationCustom08" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Email Here..." autocomplete="email" required="">
                  @error('email')
              ...
              <p class="mb-0 mt-3 text-center">Don't have an account? <a class="btn-link" href="{{url('/register')}}">Create Account</a> </p> --}}
            </form>
          </div>
        </div>
      </div>
